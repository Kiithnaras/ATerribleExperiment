...
function onInit()
	OptionsManager.registerCallback("PSMN", StateChanged);
	OptionsManager.registerCallback("PSSK", StateChanged);
	StateChanged();
end

function onClose()
	OptionsManager.unregisterCallback("PSMN", StateChanged);
	OptionsManager.unregisterCallback("PSSK", StateChanged);
end
...
function StateChanged()
	...
	if OptionsManager.isOption("PSSK", "on") then
