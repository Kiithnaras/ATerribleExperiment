...
function addMenuChoices()
	...
	registerMenuItem("More", "radial_heal", 5);
	...
	registerMenuItem("More", "radial_heal", 8, 5);
	...
	registerMenuItem("More", "radial_heal", 7, 5);
	...
	registerMenuItem("More", "radial_heal", 6, 5);
	...
	registerMenuItem("More", "radial_heal", 5, 8, 5);
	...
	registerMenuItem("More", "radial_heal", 5, 7, 5);
	...
	registerMenuItem("More", "radial_heal", 5, 6, 5);
	...
	registerMenuItem("More", "radial_heal", 5, 5, 5);
